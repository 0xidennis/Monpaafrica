...
// 100% PIXEL-PERFECT (Tailwind-only with precise arbitrary values + SVGs)
        ...
        <div className="min-h-screen grid md:grid-cols-2 bg-[#F8FAFC] text-[#0F172A]">
            ...
            <div className="flex items-center justify-center px-[40px] py-[48px]">
                <div className="w-full max-w-[420px]">
                    ...
                    <p className="text-[0.92rem] text-[#64748B] mb-[32px]">Already have an account? <span className="text-[#2563EB] font-semibold cursor-pointer">Sign in</span></p>

                    <div className="grid grid-cols-2 gap-[16px] mb-[18px]">
                        <input className="p-[12px_16px] border-[1.5px] border-[#E2E8F0] rounded-[10px]" placeholder="Chidi" />
                        <input className="p-[12px_16px] border-[1.5px] border-[#E2E8F0] rounded-[10px]" placeholder="Okonkwo" />
                    </div>

                    <input className="w-full p-[12px_16px] border-[1.5px] border-[#E2E8F0] rounded-[10px] mb-[18px]" placeholder="you@example.com" />
                    <input className="w-full p-[12px_16px] border-[1.5px] border-[#E2E8F0] rounded-[10px] mb-[18px]" placeholder="0801 234 5678" />

                    <select className="w-full p-[12px_16px] border-[1.5px] border-[#E2E8F0] rounded-[10px] mb-[18px] appearance-none bg-[url('data:image/svg+xml,%3Csvg width=12 height=8 viewBox=0 0 12 8 fill=none xmlns=http://www.w3.org/2000/svg%3E%3Cpath d=M1 1l5 5 5-5 stroke=%2364748B stroke-width=1.5 stroke-linecap=round stroke-linejoin=round/%3E%3C/svg%3E')] bg-no-repeat bg-[right_14px_center]">
                    ...
                    <button className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-bold text-[0.95rem] py-[14px] rounded-[10px] flex items-center justify-center gap-[8px]">
                        Create free account
